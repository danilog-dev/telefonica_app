            ...
            <div className="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 sm:p-8 space-y-4 text-center">
              ...
              {contact.telefono ? (
                <a
                  ...
                  className="w-full py-5 px-6 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white font-extrabold text-2xl sm:text-3xl shadow-md hover:shadow-lg transition-all active:scale-[0.98] flex items-center justify-center gap-3.5 text-center cursor-pointer select-none tracking-wide"
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                <div className="p-5 bg-slate-100 rounded-xl text-center text-slate-500 font-semibold text-base">
              ...
              <div className="pt-1">
                <button
                  ...
                  className="text-xs sm:text-sm font-medium text-slate-400 hover:text-slate-600 underline underline-offset-4 py-1.5 transition-colors cursor-pointer disabled:opacity-50"
                >
